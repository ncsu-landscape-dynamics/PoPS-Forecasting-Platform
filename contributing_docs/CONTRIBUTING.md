...
Please note that 'PoPS is released with a [Contributor Code of Conduct](contributing_docs/CODE_OF_CONDUCT.md). By contributing to this project, 
...
1.  __Use PoPS coding style__. Please follow the
    [PoPS style guide](contributing_docs/STYLE_GUIDE.md). Maintaining
    a consistent style across the whole code base makes it much easier to
    jump into the code. If you're modifying existing PoPS dashboard code that
