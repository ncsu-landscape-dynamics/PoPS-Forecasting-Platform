...
class PestInformation(models.Model):
    ...
    thumbnail = models.FileField(verbose_name = "Small thumbnail image of pest/pathogen", help_text="Upload thumbnail image of pest/pathogen.",upload_to="pest_images", max_length=100, blank=True, null=True)
