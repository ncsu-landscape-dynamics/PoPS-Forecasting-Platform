    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('infected_area', models.DecimalField(blank=True, decimal_places=2, default=1, help_text='Overall infected area from the run.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)], verbose_name='infected_area')),
                ('years', models.PositiveIntegerField(default=2020, null=True, validators=[django.core.validators.MinValueValidator(2018)], verbose_name='year')),
                ('spread_map', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
            ],
            options={
                'verbose_name': 'output',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=150, verbose_name='run name')),
                ('description', models.TextField(blank=True, help_text='Give your run a description.', max_length=300, null=True, verbose_name='run description')),
                ('random_seed', models.PositiveIntegerField(default=None, null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='random seed')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='date created')),
                ('status', models.CharField(blank=True, choices=[('PENDING', 'Pending'), ('IN PROGRESS', 'In progress'), ('FAILED', 'Failed'), ('SUCCESS', 'Successful')], default='PENDING', max_length=20, verbose_name='run status')),
                ...
                ('budget', models.PositiveIntegerField(default=10, null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='budget')),
                ('cost_per_hectare', models.PositiveIntegerField(default=1000, null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='cost per hectare')),
                ...
                ('final_year', models.PositiveIntegerField(default=2020, null=True, validators=[django.core.validators.MinValueValidator(2018)], verbose_name='final run year')),
                ('management_polygons', django.contrib.postgres.fields.jsonb.JSONField()),
            ],
            options={
                'verbose_name': 'run',
