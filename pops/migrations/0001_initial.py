# Generated by Django 2.2.3 on 2019-08-07 18:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.DecimalField(blank=True, decimal_places=0, max_digits=5, verbose_name='short distance scale value')),
                ('probability', models.DecimalField(blank=True, decimal_places=2, max_digits=5, verbose_name='short distance scale probability')),
        ...
        migrations.CreateModel(
            name='PercentShortDistance',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.DecimalField(blank=True, decimal_places=0, max_digits=5, verbose_name='percent short distance scale value')),
                ('probability', models.DecimalField(blank=True, decimal_places=2, max_digits=5, verbose_name='percent short distance scale probability')),
                ('pest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pops.Pest', verbose_name='pest')),
            ],
            options={
                'verbose_name': 'short distance dispersal percentage',
                'verbose_name_plural': 'short distance dispersal percentages',
            },
        ),
        migrations.CreateModel(
            name='Output',
            fields=[
                ...
                ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pops.Run', verbose_name='run id')),
            ],
            options={
                'verbose_name': 'output',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.DecimalField(blank=True, decimal_places=0, max_digits=5, verbose_name='long distance scale value')),
                ('probability', models.DecimalField(blank=True, decimal_places=2, max_digits=5, verbose_name='long distance scale probability')),
                ('pest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pops.Pest', verbose_name='pest')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='VectorShortDistance',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.DecimalField(blank=True, decimal_places=0, max_digits=5, verbose_name='vector short distance scale value')),
                ('probability', models.DecimalField(blank=True, decimal_places=2, max_digits=5, verbose_name='vector short distance scale probability')),
                ('vector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pops.Vector', verbose_name='vector')),
            ],
            options={
                'verbose_name': 'vector short distance dispersal',
                'verbose_name_plural': 'vector short distance dispersals',
            },
        ),
        migrations.CreateModel(
